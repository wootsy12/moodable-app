...
public class FaceView extends View {
    ...
    private void drawFaceAnnotations(Canvas canvas, double scale) {
        ...
        for (int i = 0; i < mFaces.size(); ++i) {
            ...
            float top = face.getPosition().y + face.getHeight();
            float right = face.getPosition().x + face.getWidth();
            float bottom = face.getPosition().y;
            canvas.drawRect((int)(left*scale), (int)(top*scale), (int)(right* scale), (int)(bottom* scale), paint);
        }
    }
}