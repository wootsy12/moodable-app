...
public class LockActivity extends AppCompatActivity {
        ...
        switch (requestCode) {
            case LOCK_REQUEST_CODE:
                if (resultCode == RESULT_OK) {
                    ...
                    startActivity(new Intent(LockActivity.this, PhqActivity.class));
    ...
    private boolean isDeviceSecure() {
        ...
        return Build.VERSION.SDK_INT >= Build.VERSION_CODES.M && keyguardManager.isKeyguardSecure();
                //Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN && keyguardManager.isKeyguardSecure();
